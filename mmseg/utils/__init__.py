...
from .print_log import print_metrics, print_defect_metrics, print_defect_loss
...
__all__ = ['get_root_logger', 'collect_env',
           ...
           'print_metrics', 'print_defect_metrics', 'print_defect_loss', 'StatisticTextLoggerHook']