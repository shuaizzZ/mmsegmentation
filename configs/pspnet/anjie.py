...
# ======================================= dataset settings ======================================= #
data_root = '/root/public02/manuag/zhangshuai/data/anjie'
dataset_type = 'AnjieDataset'
dataset = 'dataset/anjie0122_split_unq'
...
checkpoint_config = dict(by_epoch=True, interval=1, max_keep_ckpts=1, best_type='sum')
evaluation = dict(interval=1, metric='mIoU', rescale=False, ignore_index=[0],
                  f1_cfg=dict(com_f1=True, type='pix_iof', threshold=[0.2]*10,
                              defect_filter=dict(type='box', size=[5, 5])),
